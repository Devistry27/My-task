            ...
            <div className='container__form_Task'>
              ...
              <div className='list__buttons__form_Task'>
                <div className='list__buttons__div_Task'>
                  <input id='name' name='name' className='inputs__form_Task' type='text' placeholder='Nombra a tu tarea' required defaultValue={state.taskToUpdate ? state.taskToUpdate.name : ''} />
                  <textarea id='description' name='description' className='description inputs__form_Task' rows='10' placeholder='Ponle una descripcion a tu tarea' required defaultValue={state.taskToUpdate ? state.taskToUpdate.description : ''} />
